...
const GoogleVerifyStep3 = ({ navigation }: RootStackScreenProps<"GoogleVerifyStep3">) => {
  ...
  return (
    <Container>
      ...
      <View style={{padding:16}}>
          <Text style={{color:"#DDE0E3",fontSize:13,fontWeight:"500",marginTop:20,marginBottom:5}}>Google 驗證碼</Text>
